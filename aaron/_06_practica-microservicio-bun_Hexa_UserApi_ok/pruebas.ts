...
async function testGetUsuarioById(
  id: number
): Promise<void> {
  const response =
    await fetch(
...
function printSummary(): void {
  ...
  // Esta parte ahora sí está DENTRO de la función
  if (failed === 0) {
    console.log("\n==================================================");
    ...
    console.log("\n==================================================");
    console.log("⚠️ EXISTEN PRUEBAS FALLIDAS");
    console.log("==================================================");
  }
}
